				...
				<div class="row align-items-center">
					<div class="col-lg-5 col-md-6">
						<div class="mobile-holder-logo">
							<a href="/">
								<img src="<?php echo get_template_directory_uri(); ?>/image/logo.png" alt="Logo"> <!-- The get_template_directory_uri ensures that the selector is in the west-coast directory -->
							</a>
						</div>
					</div>
